...
SWEP.Description = [[A tactical 9mm pistol. High-capacity and lightweight; these were once the standard issue sidearm for Site-02’s on-site security. Though largely replaced by the FSP-9, some guards still covet the days when their firearm was a few pounds lighter.]]

-------------------------------------------------------------------------------------------------------
-- Viewmodel & Worldmodel -----------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.ViewModel = "models/weapons/arc9/scpsl/com18/v_com18.mdl"
SWEP.UseHands = true

SWEP.WorldModel = "models/weapons/w_pist_usp.mdl"
SWEP.MirrorVMWM = true 
 SWEP.WorldModelOffset = {
     Pos = Vector(-6, 2, -4), -- non tpik (while on ground, on npc etc)
     Ang = Angle(-5, 0, 180),
     TPIKPos = Vector(-12, 6, -5), -- arc9_tpik 1, you can make cool poses with it
     TPIKAng = Angle(-5, -20, 180),
     Scale = 1
 }
 -- TPIK -----------------------------------------------------------------------------------------------
SWEP.NoTPIK = false
...
-- Weapon Stats ---------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.DamageMax = 21.2 -- Damage done at point blank range --
SWEP.DamageMin = 5.3 -- Damage done at maximum range
...
SWEP.ArmorPiercing = 0.55
SWEP.Penetration = 11 -- Units of wood that can be penetrated by this gun. -- 19min to pen two targets. -- ArmorPiercing *2
...
SWEP.RangeMax = 8250 -- In Hammer units, how far bullets can travel before dealing DamageMin.
SWEP.Distance = 33000 -- In Hammer units, how far bullets can travel, period.

SWEP.PhysBulletMuzzleVelocity = 14180 -- Physical bullet muzzle velocity in Hammer Units/second. 1 HU != 1 inch.
...
SWEP.Recoil = 0.25 -- General recoil multiplier
...
SWEP.SprintPos = Vector(-0, -0, -0.25) 
...
SWEP.CustomizePos = Vector(11.5, 35, 5)
...
-- Sounds ---------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------
SWEP.ShootSound               = { "scpsl_COM18_fire" }
-- SWEP.LayerSound               = { "" }
...
SWEP.AttachmentElements = {
    ["com18_mag_bottomext"] = { Bodygroups = {{11,1},},},
	["com18_mag_bottom"] = { Bodygroups = {{11,0},},},
	["com18_optic_none"] = { Bodygroups = {{12,2},},},
	["com18_optic_iron"] = { Bodygroups = {{12,0},},},
	-- ["frmg0_barrel_short"] = {
        -- Bodygroups = {
            -- {17,1},
        -- },
...
SWEP.Attachments = {
    {
        PrintName = "Muzzle",
		Bone = "barrel",
        Category = {"scpsl_com18_muzzle", "muzzle","muzzle_pistols", "scp5k_muzzle_pistol","cod2019_muzzle"},
		-- InstalledElements = {"frmg0_muzzle_none"},
		-- UnInstalledElements = {"frmg0_muzzle"},
		Scale = 0.75,
		Pos = Vector(-0, -0.4, -1.8),
        Ang = Angle(-90, 0, -90),
    ...
    },
    {
        PrintName = "Magazine",
		Bone = "Magazine",
        Category = "scpsl_com18_mag",
		UnInstalledElements = {"com18_mag_bottom"},
		Pos = Vector(-0, 0, -0),
        Ang = Angle(0, 90, -0),
        Icon_Offset = Vector(0, 0, 0),
    },
...
SWEP.Animations = {
	...
	["ready"] = {
		...
		EventTable = {
            ...
            {s = "scpsl_COM15_pull", t = 13 / 30},
			{s = "scpsl_COM15_release", t = 17 / 30},
        },
    },
    ["draw"] = {
        Source = {"draw"},
    ...
    ["reload"] = {
		...
		EventTable = {
		    ...
		    {s = "scpsl_COM18_magout", t = 6 / 30},
			{s = "scpsl_COM18_magin", t = 35 / 30},
	...
	["reload_empty"] = {
		...
		EventTable = {
			...
			{s = "scpsl_COM18_magin", t = 35 / 30},
			{s = "scpsl_COM15_ins2", t = 47 / 30},
			{s = "scpsl_COM18_pull", t = 62 / 30},
			{s = "scpsl_COM18_release", t = 66 / 30},
        },
    },
	["load"] = {
        Source = {"load"},
